package com.nebarry.webapp.config;
...
@Configuration
@EnableMongoRepositories("com.nebarry.webapp.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.nebarry.webapp.config.dbmigrations");
